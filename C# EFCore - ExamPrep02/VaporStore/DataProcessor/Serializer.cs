namespace VaporStore.DataProcessor
{
    ...
    public static class Serializer
    {
        public static string ExportGamesByGenres(VaporStoreDbContext context, string[] genreNames)
        {
            ...
            List<ExportGameDto> games = new List<ExportGameDto>();
        ...
        {
            List<ExportUserDto> users = new List<ExportUserDto>();
            ...
            {
                serializer.Serialize(sw, users.ToArray(), xmlSerializerNamespaces);
            }
