...
namespace SMS.Services
{
    public class ProductService : IProductService
    {
        ...
        public (bool isValid, string errors) ValidateModel(CreateProductViewModel model)
        {
            bool isValid = true;
        ...
        public ICollection<ProductListViewModel> GetAllProducts()
        {
        ...
        public void RegisterProduct(CreateProductViewModel model)
        {
            decimal price = 0;
